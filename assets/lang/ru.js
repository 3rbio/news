...
window.translations["ru"] = {
  ...
  news1_title: "Новый турнир объявлен",
  news1_text:
    "Мы запускаем глобальный турнир 3rb.io 2025. Регистрируйтесь и соревнуйтесь за лучшие награды!",
  news2_title: "Версия 2.0 выпущена",
  news2_text:
    "Крупное обновление: новые карты, улучшенный подбор матчей и долгожданный ночной режим.",
  ...
  vip_news_title: "VIP-подписка впервые появится в Agario Arabia!",
  vip_news_preview:
    "👇 Получите доступ к эксклюзивным функциям и контенту, доступным только VIP-участникам — следите за подробностями.",
  vip_full_content:
    "Наконец-то! В Agario Arabia запускается VIP-подписка. Вас ждёт совершенно новый опыт — уникальные преимущества и эксклюзивный контент только для премиум-игроков.",
  ...
  vip_feature_xi:
    "🏆 VIP-подписка в Agario Arabia — потому что настоящий стиль заслуживает признания.",
  /* News Page - Levels */
  levels_update_title:
